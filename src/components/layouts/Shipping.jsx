    ...
    <div className="shipping-section p-6 bg-white border rounded shadow-md">
      ...
      <div className="dropdown mb-4">
        ...
        {showDomestic && (
          <div className="dropdown-content p-4 mt-2">
            <p>
              We offer fast and reliable domestic shipping options, ensuring
              that your products arrive within 2-5 business days. All orders
              over $50 qualify for free standard shipping. Expedited shipping is
      ...
      <div className="dropdown mb-4">
        ...
        {showInternational && (
          <div className="dropdown-content p-4 mt-2 rounded">
            <p>
              For our international customers, we provide global shipping
              options with delivery times ranging from 7-14 business days,
              depending on the destination. Please note that customs fees may
              apply, and shipping rates vary by location.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="dropdown mb-4">
        ...
        {showRestrictions && (
          <div className="dropdown-content p-4 mt-2 rounded">
            <p>
              Please note that certain products cannot be shipped to specific
              regions due to local regulations and carrier restrictions. Check
              our product pages for details on restricted items and applicable
              areas.
            </p>
          </div>
        )}
        ...
        {showReturnPolicy && (
          <div className="dropdown-content p-4 mt-2 rounded">
            <p>
              ...
              unopened items. Items must be in their original packaging to
      ...
      <div className="dropdown mb-4">
        ...
        {showHowToReturn && (
          <div className="dropdown-content p-4 mt-2 rounded">
            <p>
              To return an item, please contact our customer support team for a
              return authorization number. Once approved, ship the item back to
              our provided address with the return number clearly marked on the
              package.
            </p>
          </div>
        )}
        ...
        {showRefunds && (
          <div className="dropdown-content p-4 mt-2 rounded">
            <p>
              ...
              receive and inspect your returned item. Refunds are issued to the
